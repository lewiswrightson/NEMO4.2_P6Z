MODULE par_pisces
   ...
   INTEGER, PUBLIC ::   jpcdz     !: Diazotroph carbon concentration
   INTEGER, PUBLIC ::   jpfed     !: Diazotroph iron concentration
   INTEGER, PUBLIC ::   jpchd     !: Diazotroph chlorophyll concentration
